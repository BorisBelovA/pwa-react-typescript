...
export const MyListItemButton = ({ icon, label, action, className, ...dataIds }: ListItemButtonProps): JSX.Element => {
  const theme = useTheme()
  return <ListItem {...dataIds} className={styles.list_item} disablePadding onClick={action}>
